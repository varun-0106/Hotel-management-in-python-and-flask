...
# Config MySQL
app.config['MYSQL_HOST'] = os.environ.get('MYSQL_HOST', 'localhost')  # Set default value
app.config['MYSQL_USER'] = os.environ.get('MYSQL_USER', 'root')      # Set default value
app.config['MYSQL_PASSWORD'] = os.environ.get('MYSQL_PASSWORD', 'root')  # Set default value
app.config['MYSQL_DB'] = os.environ.get('MYSQL_DB', 'hotel_management_system')  # Set default value
app.config['MYSQL_CURSORCLASS'] = os.environ.get('MYSQL_CURSORCLASS', 'DictCursor')  # Set default value
# init MYSQL
mysql = MySQL(app)
